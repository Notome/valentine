      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4">
        ...
        {answer === "yes" && (
          <div className="flex flex-col items-center mt-16 gap-8 animate-fadeIn">
            ...
            <p>
              Так люблю тебя тотика ты не представляешь, сильно сильно малыш любимый мой счастлив с<br></br> тобой безумно, ты мое солнышко и радость жизни, я так благодарна судьбе что ты у меня есть,<br></br> я тебя обожаю и хочу всегда быть рядом с тобой, ты мой единственный и неповторимый, я тебя люблю до луны и обратно!
            </p>
